...
class Display extends StatelessWidget {
	...
	final LinearGradient _gradient = const LinearGradient(colors: [ Colors.black26, Colors.black54 ]);
	...
	Widget build(BuildContext context) {
		...
		return Container(
			...
			child: Container(
				...
				child: Text(_output, style: style, textAlign: TextAlign.right , textScaleFactor: 0.8, maxLines: 2,)
			)
		);
	}
}