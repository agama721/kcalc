...
class CalculatorKey extends StatelessWidget {
	...
	Color get color {
		...
		switch (symbol.type) {
			...
			case KeyType.FUNCTION:
				return Color.fromARGB(255, 255, 150, 51);

			case KeyType.OPERATOR:
				return Color.fromARGB(255, 253, 88, 23);

			case KeyType.INTEGER:
			default:
				return Color.fromARGB(190, 200, 200, 200);
		}
	}
	...
	Widget build(BuildContext context) {
		...
		TextStyle style = Theme.of(context).textTheme.headline4.copyWith(color: Colors.black);
